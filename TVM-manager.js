...
// ####################### TVM Main functions #######################
	...
	function processMoveRequest(){
		...
		if(!LimitsTriggered()){
			...
			if(move){
				tvmClient.write(new Buffer([0x08, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
				0x68, 0x10, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00]));
			} else{
				tvmClient.write(new Buffer([0x08, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
				0xa8, 0x16, 0x4b, 0x00, 0x00, 0x00, 0x00, 0x00]));
			}
